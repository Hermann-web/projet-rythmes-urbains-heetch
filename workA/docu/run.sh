pandoc readme.md -o readme.pdf --pdf-engine=lualatex --number-sections --table-of-contents --variable=fontsize:12pt --highlight-style=pygments --metadata=author:"Hermann Agossou; Salma Khmassi; Mohamed Lamine Bamba" --variable "geometry=margin=0.8in"
